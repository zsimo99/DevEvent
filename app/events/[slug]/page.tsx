    ...
    <section id="event">
      ...
      <div className="details">
        ...
        <div className="content">
          ...
          <section className="flex-col gap-2">
            <h2>Event details</h2>
            <EventDetails label={date} alt="date" icon="/icons/calendar.svg" />
            <EventDetails label={time} alt="time" icon="/icons/clock.svg" />
            <EventDetails
              label={location}
              alt="location"
              icon="/icons/pin.svg"
            />
            <EventDetails label={mode} alt="mode" icon="/icons/mode.svg" />
            <EventDetails
              label={audience}
              alt="audience"
